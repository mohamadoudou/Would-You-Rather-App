                ...
                <div className='card__content'>
                  ...
                  <div className='answer__res'>
                    ...
                    <Card className='result__container__res' style={{ backgroundColor: highlighterOne ? '#E6E6FA' : '' }}>
                      ...
                      <LinearProgress variant="determinate" value={percentageOptionOne} style={{ height: 20 }} /><span>{percentageOptionOne.toFixed(0)}%</span>
                    ...
                    <Card className='result__container__res' style={{ backgroundColor: highlighterTwo ? '#E6E6FA' : '' }}>
                      ...
                      <LinearProgress variant="determinate" value={percentageOptionTwo} style={{ height: 20 }} /><span>{percentageOptionTwo.toFixed(0)}%</span>
